...
class PostReviews extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return PostReviewsState();
  }
}


class PostReviewsState extends State<PostReviews> {
  ...
  void initState() {
    ...
    Future<String> username= sfdata.getUserName(context);
    username.then((data) {
      setState(() {
        _userName=data;
      });
  ...
  //////////////////  SAVE //////////////////////
  Future<Null> saveReviews() async {
    EasyLoading.show(status: 'Loading');
    SharedPreferences preferences = await SharedPreferences.getInstance();
    final api = Provider.of<ApiService>(context, listen: false);
    return await api
        .sendReview(colors.hotelId,"insert",0,1,1,_userID,messageController.text,"",_userID)
        .then((result) {
      setState(() {
        EasyLoading.dismiss();
        if(result.isNotEmpty){
          commonAlert.messageAlertSuccess(context,"Thanks! for Review. Save successfully","Success");
        }else{
                  ...
                  child: Container(
                    ...
                    child: Padding(padding:const EdgeInsets.all(10.0),
                      child: Column(
                        children: [
                          Text(
                            "Leave a message",maxLines: 2,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontFamily: 'Poppins',
                                    ...
                                    child:Padding(
                                        ...
                                        child:SizedBox(
                                          ...
                                          child:TextField(
                                            ...
                                            inputFormatters: [LengthLimitingTextInputFormatter(350),FilteringTextInputFormatter.deny(
                                                RegExp(emojiRegexp))],
                                            obscureText: false,
                                            maxLines: 50,
