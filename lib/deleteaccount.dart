              ...
              child: SingleChildScrollView(
                  child: Padding(padding:const EdgeInsets.all(10.0),
                       child: Column(
                         ...
                         children: [
                           Text(
                             "Delete Account",maxLines: 2,textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                           ...
                           SizedBox(height: 5),
                           Text(
                             "Are you sure you want to delete your account? Please read how account deletion will affect.",textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                               fontWeight: FontWeight.w600,
                               fontSize: 12.0,
                           ...
                           SizedBox(height: 20),
                           Text(
                             "Account",maxLines: 2,textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                               fontWeight: FontWeight.w600,
                               fontSize: 16.0,
                           ...
                           SizedBox(height: 5),
                           Text(
                             "Deleting your account removes personal information from our database. Your email becomes permanently reserved and same email/mobile cannot be re-used to register a new account.",textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                               fontWeight: FontWeight.w600,
                               fontSize: 12.0,
                           ...
                           Text(
                             "Confirm Account deleting",maxLines: 2,textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                               fontWeight: FontWeight.w600,
                               fontSize: 16.0,
                           ...
                           Text(
                             "Enter PERMANENTLY DELETE to confirm",maxLines: 2,textAlign: TextAlign.start,
                             style: TextStyle(
                               fontFamily: 'Poppins',
                               fontWeight: FontWeight.w600,
                               fontSize: 12.0,
                             ...
                             child:Padding(
                                 ...
                                 child:SizedBox(
                                   ...
                                   child:TextField(
                                     ...
                                     inputFormatters: [LengthLimitingTextInputFormatter(50),FilteringTextInputFormatter.deny(
                                         RegExp(emojiRegexp))],
                                     obscureText: false,
                                     maxLines: 1,
                               ...
                               child: Material(
                                 ...
                                 child: MaterialButton(
                                   ...
                                   onPressed: () async {
                                     ...
                                     }else if(messageController.text != "PERMANENTLY DELETE"){
                                       commonAlert.showToast(context,"Enter correct message");  //
                                     }
                                     else{
                                       CoolAlert.show(
